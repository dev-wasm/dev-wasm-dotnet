...
internal class WasiHttpExperimental
{
    ...
    public unsafe static extern int Req(Method method, Scheme scheme, string authority, string pathWithQuery, string headers, string body, int *statusCode, int *handle);
